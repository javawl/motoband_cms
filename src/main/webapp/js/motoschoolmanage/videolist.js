...
function addConfirm(){
	var adminGuid= $("#userGuidHidden").val();
	 ...
	 var pid=	$.trim($("#ins_pid").val());
	 var videourl=	$.trim($("#ins_videourl").val());
	 var vu= $.trim($("#ins_vu").val());
		...
		$.ajax (
		{
		    ...
		    success : function (data)
		    {
			    ...
			    //	$('#addvideo').modal('hide');
			    	...
			    	$ ("#page-wrapper").load ("../motoschoolmanage/videolist?userGuid=" + adminGuid+"&page=1&limit=20&order=0");
			    }
	...
	$("#hiddenValue").val("1");
	 ...
	 var str="";
	  var datas =
		...
		{
		    type : "POST",
		    url : "../motoschoolmanage/getVideoBysid",
		    data : datas,
		    success : function (data)
		    {
			    if (data !=''&& data !=null)
			    {
			    	...
			    	$("#update_sid").val(datajson.sid);
			    	$("#update_title").val(datajson.title);
			    	$("#update_videourl").val(datajson.videourl);
			    	$("#update_vu").val(datajson.vu);
...
function editConfirm(){
	var adminGuid= $("#userGuidHidden").val();
	 ...
	 var videourl=	$.trim($("#update_videourl").val());
	 var vu=	$.trim($("#update_vu").val());
	 var pid=	$.trim($("#update_pid").val());
	 var desc = $.trim($("#update_desc").val());
	  ...
	  var datas =
		...
		{
		    type : "POST",
		    url : "../motoschoolmanage/updateVideo",
		    data : datas,
		    success : function (data)
		    {
			    if (data =='success')
