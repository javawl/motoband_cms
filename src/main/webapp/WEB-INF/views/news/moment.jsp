			...
			<div id="${tempnews.nid}"
				...
				<div style="margin-left: 20px;">
					<a class="button" href="javascript:void(0)"
						...
						onclick="addRecommendNews('${tempnews.nid}','${tempnews.userid }')">设置精选动态</a> <a
			...
			<div id="${temphots.nid}"
				...
				<div style="margin-left: 20px;">
				  <a class="button" href="javascript:void(0)"
						...
						href="javascript:void(0)"
						onclick="addRecommendNews('${temphots.nid}','${temphots.userid }')">设置精选动态</a> <a
						class="button" href="javascript:void(0)"
