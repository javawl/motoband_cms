...
<body>
  <input id="sessionUserGuidHidden" style="display: none;"
	...
	<input id="categoryid" style="display: none;" value="${categoryid}" />
	<div class="tab">
...
<div class="col-sm-3 col-md-6 col-lg-8">  --> 
	<div class="content" style="font-size: 11pt;">
		<div class="lists">
			<div id="${tempnews.nid}"
				style="background-color: #ddecdb; margin-top: 10px; height: 660px;width: 340px; margin-left: 5px; margin-right: 5px; margin-bottom: 10px; float: left;border: 2px solid #ddd;">
				<c:choose>
					<c:when test="${tempnews.type==8 }">
						<c:choose>
						  <c:when test="${tempnews.recommend==1}">
						     <div style="float: left;position:relative">
							<img style="width: 335px ;height:335px" src="${tempnews.picurl }">
				   ...
				   <c:when test="${tempnews.categoryid == 1 }">
				      <div>动态分类:<span id="${tempnews.nid }1">用车经验</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
					</c:when>
				   <c:when test="${tempnews.categoryid == 2 }">
				      <div>动态分类:<span id="${tempnews.nid }2">摩旅游记</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${tempnews.categoryid == 3 }">
				      <div>动态分类:<span id="${tempnews.nid }3">评测</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button>
				      <button class="btn btn-info btn-xs" onclick="javascript:changeNewmotomodelCePing('${tempnews.nid}')">添至车友测评</button>
				      </div>
				   </c:when>
				   <c:when test="${tempnews.categoryid == 4 }">
				      <div>动态分类:<span id="${tempnews.nid }4">生活文化</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${tempnews.categoryid == 5 }">
				      <div>动态分类:<span id="${tempnews.nid }5">改装</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${tempnews.categoryid == 6 }">
				      <div>动态分类:<span id="${tempnews.nid }6">竞技极限</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
				   </c:when>
				  <c:otherwise>
				       <div>动态分类:<span id="${tempnews.nid }0">未分类</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${tempnews.nid}','${tempnews.categoryid}')">更改分类</button>
				       &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${tempnews.nid}','${tempnews.categoryid}')">从分类中移除</button></div>
				  </c:otherwise>
				</c:choose>
			...
			<div id="${temphots.nid}"
				...
				<c:choose>
				  ...
				  <c:when test="${temphots.recommend==1}">
				     <div style="float: left;position:relative">
					   <img style="width: 335px ;height:335px" src="${temphots.picurl }">
					   <button class="btn btn-warning btn-sm" style="position:absolute;right:-1px;top:-1px;">精</button>
				    </div>
				  </c:when>
				  <c:otherwise>
				      <div style="float: left;">
					  <img style="width: 335px ;height:335px" src="${temphots.linkurl }">
				     </div>
				  </c:otherwise>
				</c:choose>
				   ...
				   <c:when test="${temphots.categoryid == 1 }">
				      <div>动态分类:<span id="${temphots.nid }1">用车经验</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
					</c:when>
				   <c:when test="${temphots.categoryid == 2 }">
				      <div>动态分类:<span id="${temphots.nid }2">摩旅游记</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${temphots.categoryid == 3 }">
				      <div>动态分类:<span id="${temphots.nid }3">评测</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button>
				       <button class="btn btn-info btn-xs" onclick="javascript:changeNewmotomodelCePing('${temphots.nid}')">添至车友测评</button>
				      </div>
				   </c:when>
				   <c:when test="${temphots.categoryid == 4 }">
				      <div>动态分类:<span id="${temphots.nid }4">生活文化</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${temphots.categoryid == 5 }">
				      <div>动态分类:<span id="${temphots.nid }5">改装</span> &nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
				   </c:when>
				   <c:when test="${temphots.categoryid == 6 }">
				      <div>动态分类:<span id="${temphots.nid }6">竞技极限</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
				   </c:when>
				  <c:otherwise>
				       <div>动态分类:<span id="${temphots.nid }0">未分类</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				       &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button></div>
				  </c:otherwise>
				</c:choose>
						<div style="margin-left: 20px;">
				  ...
				  <c:otherwise>
				   ...
				   <c:when test="${temphots.categoryid == 3 }">
				      <div>动态分类:<span id="${temphots.nid }3">评测&nbsp</span><button class="btn btn-primary btn-xs" onclick="javascript:changeCategory('${temphots.nid}','${temphots.categoryid}')">更改分类</button>
				      &nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory('${temphots.nid}','${temphots.categoryid}')">从分类中移除</button>
				       <button class="btn btn-info btn-xs" onclick="javascript:changeNewmotomodelCePing('${temphots.nid}')">添至车友测评</button>
				      </div>
				   </c:when>
				                            ...
				                            loadDownFn : function (me)
				                            {
						                        ...
						                        //    console.log(datas);
						                           $.ajax (
						                                    {
						                                        type : 'POST',
						                                        url : '../news/getmorenewsbycategory',
						                                        ...
						                                        success : function (data)
						                                        {
							                                        ...
							                                        if (json != null && json !='')
							                                        {
								                                        ...
								                                        for (var i = 0; i < returndata.length; i++)
								                                        {
									                                        ...
									                                        {
										                                        newstype = returndata[i].type
									                                        }
									                                        if(returndata[i].type==8){
									                                        	result += '<div id="'+returndata[i].nid+'"style="background-color:#ddecdb;margin-top: 10px; height: 660px;width: 340px; margin-left: 5px; margin-right: 5px; margin-bottom:10px;float:left; border: 2px solid #ddd;">';
										                                        if(returndata[i].recommend==1){
										                                        	if(typeof(returndata[i].motoboxmodel)=="undefined"){
										                                        		result+=' <div style="float:left;position:relative"><img style="width:335px;height:335px" src=""><button class="btn btn-warning btn-sm" style="position:absolute;right:-1px;top:-1px;">精</button></div>';
										                                        	}else{
										                                        	...
										                                        	if(typeof(returndata[i].motoboxmodel)=="undefined"){
										                                        		result+=' <div style="float:left;"><img style="width:335px;height:335px" src=""></div>';
										                                        	}else{
								                                                ...
								                                                if(typeof(returndata[i].motoboxmodel)!="undefined"){
								                                                	   ...
								                                                	   result+=' <div>标题：'
										                                                ...
										                                                +returndata[i].title 
										                                                +'</div><div>boxurl：'
										                                                +returndata[i].linkurl
										                                                +'</div>';
								                                                }else{
								                                                	 result+=' <div><font color="red">无手册!!!</font></div>';
								                                                }
								                                                result+=' <div>动态keyword：'
									                                        	  ...
									                                        	  switch (returndata[i].categoryid){
									                                                case 1:
									                                                	 result += '<div>动态分类:<span id="'+returndata[i].nid+'1">用车经验</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory(\''
									                                                			...
									                                                			+'\')">更改分类</button>'
									                                                			+'&nbsp&nbsp<button class="btn btn-danger btn-xs" onclick="javascript:deleteFromCategory(\''
									                                                			+returndata[i].nid
									                                                			+'\',\''+returndata[i].categoryid
									                                                			+'\')">从分类中移除</button></div>';
									                                                	break;
									                                                ...
									                                                case 3:
									                                                	 result += '<div>动态分类:<span id="'+returndata[i].nid+'3">评测</span>&nbsp<button class="btn btn-primary btn-xs" onclick="javascript:changeCategory(\''
									                                                			...
									                                                			+'\',\''+returndata[i].categoryid
									                                                			+'\')">从分类中移除</button>'
									                                                			+'<button class="btn btn-info btn-xs" onclick="javascript:changeNewmotomodelCePing(\''
									                                                			+returndata[i].nid
									                                                			+'\')">添至车友测评</button></div>';
									                                                	break;
									                                                case 4:
									                                        	...
									                                        	result+='<a class="button" href="javascript:void(0)" onclick="addRecommendNews(\''
								                                                + returndata[i].nid
								                                                + '\',\''+returndata[i].userid
					                            ...
					                            else if (itemIndex == '1')
					                            {
						                            ...
						                            $.ajax (
						                                    {
						                                        type : 'POST',
						                                        url : '../news/getmorecategoryrecommend',
						                                    //    data : JSON.stringify (datas),
						                                        data : datas,
						                                     //   dataType : 'json',
						                                        success : function (data)
									                                        ...
									                                        if(returndata[i].type==8){
										                                        ...
										                                        if(returndata[i].recommend==1){
										                                        	if(typeof(returndata[i].motoboxmodel)=="undefined"){
										                                        		...
										                                        		result+=' <div style="float:left;position:relative"><img style="width:335px;height:335px" src="' + returndata[i].picurl + '"><button class="btn btn-warning btn-sm" style="position:absolute;right:-1px;top:-1px;">精</button></div>';
										                                        	}
										                                        	...
										                                        	if(typeof(returndata[i].motoboxmodel)=="undefined"){
										                                        		...
										                                        		result+=' <div style="float:left;"><img style="width:335px;height:335px" src="' + returndata[i].picurl + '"></div>';
										                                        	}
...
<div class="modal-content">
   	...
   	<div id="NewmotomodelCePing" style="display:none; POSITION:fixed; left:50%; top:50%; width:600px;  margin-left:-300px; margin-top:-200px; text-align:center">
<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true" onclick="javascript:closeNewmotomodelCePingModel()">&times;</button>
					<h4 class="modal-title" id="myModalLabel">添加测评车型</h4>
				</div>
				<div class="modal-body">
				...
				<input class="form-control"  id="newmotomodelceping_nid"
							style="display: none;" value="">
						
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal"
						id="closedelBoxModel" onclick="javascript:closeNewmotomodelCePingModel()">关闭</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						onclick="javascript:changeNewmotomodelCePingConfirm()">确认</button>
				</div>
			</div>
   </div>
