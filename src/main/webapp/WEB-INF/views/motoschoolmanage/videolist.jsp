...
<body onload="">
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">骑行学院管理</h1>
		</div>
		<!-- /.col-lg-12 -->
	</div>
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">骑行学院视频列表&nbsp<button type="button" class="btn btn-success" data-toggle="modal"
		data-target="#addvideo"  onclick="javascript:addvideo()">添加视频</button></div>
				<!-- /.panel-heading -->
				<div class="panel-body">
					...
					<div class="col-sm-3" style="padding-left: 0; margin-bottom: 15px">
                      <div>
							  ...
							  <select class="form-control" id="pageSizeSelect"  onchange="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1')">
								...
								<th>orderindex<span>&nbsp</span>
									 <c:choose>
									  <c:when test="${order== '0' && orderConditions=='orderindex'}">
									     <a class="down" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','1','orderindex')" style="text-decoration:none;">▼</a>   
									  </c:when>
									  <c:when test="${order== '1'  && orderConditions=='orderindex'}">
									     <a class="up" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','0','orderindex')"   style="text-decoration:none;">▲</a>
									  </c:when>
									  <c:otherwise>
									     <a class="up_down" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','1','orderindex')"   style="text-decoration:none;">◊</a>									     
									  </c:otherwise>
									</c:choose> 
									</th>
									<th>sid<span>&nbsp</span>
									 <c:choose>
									  <c:when test="${order== '0' && orderConditions=='sid'}">
									     <a class="down" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','1','sid')" style="text-decoration:none;">▼</a>   
									  </c:when>
									  <c:when test="${order== '1'  && orderConditions=='sid'}">
									     <a class="up" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','0','sid')"   style="text-decoration:none;">▲</a>
									  </c:when>
									  <c:otherwise>
									     <a class="up_down" href="javascript:changeTriangle('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1','1','sid')"   style="text-decoration:none;">◊</a>									     
									  </c:otherwise>
									</c:choose> 
									</th>
									<th>title</th>
							...
							<tbody>
								<c:forEach items="${videolist}" var="list"
									...
									<td>${list.orderindex}</td>
									   ...
									   <td >${list.title}</td>
									   <td >${list.pid}</td>
									   <td >${list.schoolpackagetitle}</td>
									   <td >${list.desc}</td>
									   <td ><img alt="" src="${list.picurl}" style="width: 100px;height: 100px"></td>
									   <td >${list.videourl}</td>
									   <td >${list.vu}</td>
									...
									<c:choose>
										...
										<td class="center">
											<button type="button" class="btn btn-success" data-toggle="modal" data-target="#editvideo" onclick="javascript:editvideo('${list.sid}')">编辑</button>
			...
			<c:if test="${pageBean.page != 1 }">
				<a class="btn btn-primary" href="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','1')">首页</a>
				<a class="btn btn-primary" href="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','${pageBean.page-1}')">上一页</a>
			</c:if>
			   ...
			   <c:when test="${pageBean.totalPage >10}">
			       ...
			       <c:forEach var="i" begin="1" end="5">
				          ...
				          <c:when test="${pageBean.page != i }">
					          <a class="btn btn-primary" href="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','${i}')">${i}</a>
				          </c:when>
						  <c:otherwise>
			      ...
			      <c:if test="${pageBean.page  != pageBean.totalPage}">
						<a class="btn btn-primary" href="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','${pageBean.page+1}')">下一页</a>
						<a class="btn btn-primary" href="javascript:pageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','${pageBean.totalPage}')">尾页</a>
			     </c:if>
			   </c:when>
			   <c:otherwise>
			...
			<span>&nbsp输入页数：</span>
			<span><input type="text" id="inputPage" size="5"/>&nbsp<button type="button"  class="btn btn-success btn-lg" onclick="javascript:inputPageGoto('/motoschoolmanage/videolist','${sessionScope.user.user_guid}','${pageBean.totalPage}')" >跳转</button></span>
			...
			<div class="modal-content">
				...
				<div class="form-group">
					...
					<div class="col-sm-6" style="padding-bottom: 10px">
					    <label>desc</label>
						<textarea class="form-control" placeholder="" id="ins_desc"
				   ...
				   <div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6" >
						<label>pid</label>
							<select class="form-control" id="ins_pid">
					...
					<div class="col-sm-6">
						...
						<input class="form-control" placeholder="" id="ins_videourl"
							value="" >
					</div>
					<div class="col-sm-6">
					    <label>vu</label>
						<input class="form-control" placeholder="" id="ins_vu"
							value="" >
					</div>
				</div>
				</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="height:500px">
				  <div class="form-group">
					<div class="col-sm-6">
					    <label>sid</label>
						<input class="form-control" placeholder="" id="update_sid"
				...
				<div class="form-group">
					<div class="col-sm-6" style="padding-bottom: 10px">
					    <label>desc</label>
						<textarea class="form-control" placeholder="" id="update_desc"
							cols="5" rows="5" ></textarea>
					</div>
				</div>
				   ...
				   <div class="form-group">
					...
					<div class="col-sm-6">
					    <label>videourl</label>
						<input class="form-control" placeholder="" id="update_videourl"
							value="" >
					</div>
					<div class="col-sm-6">
					    <label>vu</label>
						<input class="form-control" placeholder="" id="update_vu"
							value="" >
					</div>
				</div>
	...
	<script src="../js/motoschoolmanage/videolist.js"></script> 
