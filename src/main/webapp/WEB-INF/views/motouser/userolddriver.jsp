	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">老司机用户</div>
				<!-- /.panel-heading -->
											...
											<c:choose>
												<c:when test="${updateCheck=='lock'}">
													<button type="button" class="btn btn-primary btn-lg"
														...
														onclick="javascript:updateOlddriverScore('${userMessages.userid}')">编辑</button>
													<!--  -->
												</c:when>
												<c:otherwise>
													<button type="button"
												...
												<c:when test="${delCheck=='lock'}">
													<button type="button" class="btn btn-primary btn-lg"
														...
														onclick="javascript:delOlddriverdiag('${userMessages.userid}')">删除</button>
												</c:when>
												<c:otherwise>
													<button type="button"
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">删除老司机</h4>
				</div>
				<div class="modal-body">
					<input type="text" value="" style="display: none" id="deluserid">
					<h3>删除后无法恢复</h3>
				</div>
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						onclick="javascript:delOlddriver()">确认删除</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						<input class="form-control" placeholder="" id="update_userid"
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal"
						onclick="javascript:saveOlddriver()" id="savebtn">保存</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
